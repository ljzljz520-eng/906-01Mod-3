            ...
            <div class="flex justify-between items-start gap-4 mb-4">
              <div class="flex-1">
                ...
                <div class="flex flex-wrap gap-2 items-center">
                  ...
                  <a
                    v-if="item.License || item.LicenseUrl"
                    :href="item.LicenseUrl || (getLicenseMeta(item.License)?.url)"
                    target="_blank"
                    ...
                    :title="getLicenseMeta(item.License)?.description || '查看许可证详情'"
                  >
                    <svg class="w-3.5 h-3.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
                    </svg>
                    <span>{{ item.License || '许可证详情' }}</span>
                  </a>
                  <span
                    v-else
...
import { ref } from 'vue'
import api from '../api'
import { normalizeLicense, getLicenseMeta } from '../utils/licenseAnalyzer'
